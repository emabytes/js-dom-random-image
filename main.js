...
let title = document.createTextNode("Show random image with JS")
...
button.addEventListener("click", function showRandomImg() {
    let randomImg = data[Math.floor(Math.random() * data.length)].download_url;
    img.src = `${randomImg}`
